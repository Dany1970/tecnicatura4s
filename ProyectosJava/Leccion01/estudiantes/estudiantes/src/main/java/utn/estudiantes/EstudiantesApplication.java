...
import utn.estudiantes.EstudiantesApplication;
		...
		switch (opcion){
			...
			case 4 -> { //Modificar estudiante
				...
				if(estudiante != null){
					...
					estudiante.setEmail(email);
					estudianteServicio.guardarEstudiante(estudiante);
					logger.info("Estudiante modificado: "+esntudiante+nl);
			...
			case 5 -> {//Eliminar estudiante
				...
				var idEstudiante = Integer.parseInt(consola.nextLine());
				// Buscamos el id estudianye a eliminar
				var estudiante = estudianteServicio.buscarEstudianyePorId(idEstudiante);
				if (estudiante != null) {
					estudianteServicio.eliminarEstudiante(estudiante);
					logger.info("Estudiante eliminado: " + estudiante + nl);
				} else
					logger.info("Estudianye NO encontrado con id: " + estudiante + nl);
			}
			case 6 ->{ //Salir
				logger.info(Hasta pronto!!+nl+nl);
				salir = true;
			}
			default -> ogger.info("Opción no reconocida: "+ opcion+nl);
		}//Fin switch
		return salir;
